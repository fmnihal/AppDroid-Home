        ...
        <div className='bg-[#f1f5e8]'>
                ...
                <div className='container mx-auto px-4'>
                    ...
                    <div className='flex justify-around items-center text-center'>
                        <div className='p-4'>
                            ...
                            <p className='text-green-300 text-sm mt-1'>21% More Than Last Month</p>
                        </div>
                        <div className='p-4'>
                            <p className='text-lg'>Total Reviews</p>
                            <h1 className='text-4xl font-extrabold mt-1'>906K</h1>
                            <p className='text-green-300 text-sm mt-1'>46% More Than Last Month</p>
                        </div>
                        <div className='p-4'>
                            <p className='text-lg'>Active Apps</p>
                            <h1 className='text-4xl font-extrabold mt-1'>132+</h1>
                            <p className='text-green-300 text-sm mt-1'>31 More Will Launch</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='container mx-auto px-4 py-16'>
                ...
                <div className='text-center mt-12'>
                    <Link to="/apps">
                        <button className="btn btn-primary text-white px-6 py-3 rounded-lg shadow-md">Show All ({totalApps})</button>
                    </Link>
                </div>
            </div>
